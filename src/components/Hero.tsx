        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 md:mb-14">
            <h1 className="premium-heading mb-6 text-black">
              Automate Your Sales Process, <br className="hidden md:block" />
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto px-4 sm:px-0">
              FireLink builds AI-powered sales systems to help businesses scale faster, smarter, and more efficiently by automating the sales process.
            </p>
