        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-firelink-purple transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:info@firelinkautomations.com" className="text-gray-400 hover:text-firelink-purple transition-colors">info@firelinkautomations.com</a></li>
            </ul>
          </div>
        </div>
