        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:paul@jpstrategies.xyz" className="text-gray-400 hover:text-firelink-purple transition-colors flex items-center">
                <Mail className="mr-2 h-4 w-4" />paul@jpstrategies.xyz
              </a></li>
            </ul>
          </div>
        </div>
